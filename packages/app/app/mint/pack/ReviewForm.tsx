...
export const ReviewForm = () => {
  ...
  return (
    <div className="flex flex-col w-full gap-2">
      ...
      <ReviewData eth={amountEth} modules={modules} />
      <table className="font-semibold mt-4">
        <tbody>
          ...
          <tr>
            ...
            <td className="text-right">0 ETH (Pack Self-Funded)</td>
          </tr>
        </tbody>
      </table>
    </div>
    ...
    <>
      ...
      {modules.map((module, index) => {
        if (module.moduleAddress === addresses.ERC721Module) {
          return (
            <Erc721Card key={module.address + module.value} module={module} />
          );
        }
        if (module.moduleAddress === addresses.ERC20Module) {
          return (
            <Erc20Card key={module.address + module.value} module={module} />
          );
        }
        return (
          <ContentCard key={module.address + module.value}>
